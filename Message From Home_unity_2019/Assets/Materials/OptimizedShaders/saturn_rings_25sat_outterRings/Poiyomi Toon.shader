Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/946d9840dd4b51148bf60aa6d4e764ba"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((3.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					#endif
					float2 ToonAddGradient = float2((0.001 /*_LightingAdditiveGradientStart*/), (0.0 /*_LightingAdditiveGradientEnd*/));
			...
			{
				float3 backlightColor = float4(1,1,1,1).rgb;
				#if defined(PROP_BACKLIGHTCOLORTEX) || !defined(OPTIMIZER_ENABLED)
				...
				float backlightFactor = pow(saturate(-headDotLight * 0.5 + 0.5), max(0, (0.0 /*_BacklightDirectivity*/)));
				...
				#endif
				backlightLN = poiEdgeLinear(backlightLN, (0.0 /*_BacklightBorder*/), (1.0 /*_BacklightBlur*/));
				float backlight = saturate(backlightFactor * backlightLN);
				backlight = !poiMesh.isFrontFace && (0 /*_BacklightBackfaceMask*/) ? 0.0 : backlight;
				backlightColor = lerp(backlightColor, backlightColor * poiFragData.baseColor, (1.0 /*_BacklightMainStrength*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					mainUV = sharpSample(float4(0.0002441406,0.0625,4096,16), mainUV);
				}
				...
				if ((1.0 /*_MainGradationStrength*/) && (0.0 /*_ColorGradingToggle*/))
				{
					#if !defined(UNITY_COLORSPACE_GAMMA)
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, pow(abs(poiFragData.baseColor), (0.72 /*_MainGamma*/)), hueShiftAlpha.a);
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - ((3.64 /*_Saturation*/)) * hueShiftAlpha.b);
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * ((-0.9 /*_MainBrightness*/) + 1), hueShiftAlpha.g));
				#endif
				...
				clip(poiFragData.alpha - (0.69 /*_Cutoff*/));
				...
				poiFragData.finalColor = poiFragData.finalColor + ((GetFogIntensity(fogDistance, (0.0 /*_FogStartOffset*/), (1.0 /*_FogScale*/)) + 1) * fogCol.rgb);
				poiFragData.alpha = poiFragData.alpha + ((GetFogIntensity(fogDistance, (0.0 /*_FogStartOffset*/), (1.0 /*_FogScale*/)) + 1) * fogCol.a);
				#endif
				#endif
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiFragData.alpha = saturate(poiFragData.alpha * (100.0 /*_AlphaBoostFA*/));
				}
